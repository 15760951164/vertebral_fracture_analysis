...
class loacte_dataset(Dataset):
    ...
    def __init__(self, data_dir, stack=False):
        ...
        train_ids = os.listdir(data_dir)[:10]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--train_dataset_dir',
        type=str,
        default="data/idv_locate_1_channel/train")

    parser.add_argument(
        '--test_dataset_dir',
        type=str,
        default="data/idv_locate_1_channel/test")
    ...
    parser.add_argument('--lambda_l2', type=int, default=40)
    ...
    model = SCN_Modify.SCN(in_channels=1, out_channels=1, f_maps=32, dropout_prob=0.2)
